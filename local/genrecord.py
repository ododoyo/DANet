...
list_pattern = "/mnt/hd8t/fsl/SpeechSeparation/mix/mix2spk/mix_2_spk_min_{}_mix.time.sort"
wav_dir = "/mnt/hd8t/fsl/SpeechSeparation/mix/data/2speakers/wav8k/min"
data_type = ['tr', 'cv', 'tt']
pre_pattern = "mix_2_spk_min_"
fs8k = 8000
size = 256
shift = 64
feat_dims = size // 2 + 1
