...
if 'KALDI_DIR' not in os.environ:
    # Default! To change run python with 'export KALDI_DIR=/some_dir python'
    os.environ['KALDI_DIR']='/home/fsl/workspace/course_asr/Kaldi/kaldi'

# Add kaldi tools to path,
os.environ['PATH'] = os.popen('echo $KALDI_DIR/src/bin:$KALDI_DIR/tools/openfst/bin:$KALDI_DIR/src/fstbin/:'
                              '$KALDI_DIR/src/gmmbin/:$KALDI_DIR/src/featbin/:$KALDI_DIR/src/lm/:$KALDI_DIR/'
                              'src/sgmmbin/:$KALDI_DIR/src/sgmm2bin/:$KALDI_DIR/src/fgmmbin/:$KALDI_DIR/src/latbin/:'
                              '$KALDI_DIR/src/nnetbin:$KALDI_DIR/src/nnet2bin:$KALDI_DIR/src/nnet3bin:$KALDI_DIR/'
                              'src/online2bin/:$KALDI_DIR/src/ivectorbin/:$KALDI_DIR/src/lmbin/').readline().strip() + \
                                ':' + os.environ['PATH']
